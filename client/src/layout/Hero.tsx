...
const Hero = () => {
  return (
    <div className="w-full h-screen flex flex-col md:flex-row bg-sandBrown/30 relative overflow-hidden">
      <div className="content w-full h-full pt-40 gap-3 px-10 md:absolute z-[1] left-0 top-0 flex flex-col justify-start items-start">
        <h1 className="text-7xl/15 2xl:text-8xl/20 font-grotesk text-charcoal font-medium flex flex-col">
          <span>Your Desk.</span>
          <span>Your Ritual.</span>
        </h1>
        <p className="md:w-1/2 text-lg 2xl:text-2xl leading-4 flex gap-1 text-charcoal flex-wrap">
