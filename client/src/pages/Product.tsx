...
const ProductPage: React.FC = () => {
  ...
  const detail = productDetails[slug as keyof typeof productDetails] as ProductDetail;

  if (!product || !detail) {
    return <div className="text-center text-charcoal font-grotesk">Product not found</div>;
  }
